...
== Changelog ==
= 1.1.73 =
* Add multiple parameters to identify properly orders in legacy order storage and/or HPOS.

= 1.1.72 =
* Normalized order numbers in various request.

= 1.1.71 =
* Normalized the amount formatting in various request.

= 1.1.70 =
* Revised the signature calculation.

= 1.1.63 =
* Changed the way the checkout javascript code (postViabillPaymentForm) is executed.

= 1.1.61 =
* Changed the Order Number assignment to match closer the transaction Id.

= 1.1.60 =
* Minor changes in the retrieval of the plugin settings.

= 1.1.59 =
* Updated the way of how to disable a 3rd party payment method is performed.

= 1.1.58 =
* Added a safeguard for the defintion of VIABILL_DIR_PATH.

= 1.1.57 =
* Added a theme option for the checkout tagline (light, dark).
* Changed the way the checkout javascript code (postViabillPaymentForm) is executed.

= 1.1.56 =
* Pre-fill capture option.
* Allow users to specify the "capture order on status change" statuses.
